                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="row" style="margin: 10px 0;font-size: 16px;font-weight: bolder;">
                                                                    尊敬的<spqn id="username" style="white-space: nowrap;"><%=username%></spqn>：
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="center">
                                                                <div style="vertical-align: middle;">
                                                                    <p style="font-size: 14px; color: #3C4858;; margin:0 0 5px 0;">
                                                                        感谢您对Kaneziki的关注与支持</p>
                                                                    <p style="margin: 0; font-size: 12px; color: #8796A8;">
                                                                        如有疑问可联系我们：17331987381 | <a href="#" style="color: #4289DB; text-decoration: none;">1848224883@qq.com</a>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
