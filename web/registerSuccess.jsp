...
<div id="js-alert-box" class="alert-box" style="display: block;">
    ...
    <div id="js-sec-text" class="alert-sec-text">10</div>
    <div class="alert-body">
        <div id="js-alert-head" class="alert-head">即将前往验证码验证...</div>
        <div class="alert-concent">
            <p>已发送注册码到您的邮箱</p>
            <p>请前往邮箱进行验证</p>
        </div>
        <a id="js-alert-btn" class="alert-btn" href="verify.jsp">立即前往验证</a>
    </div>
